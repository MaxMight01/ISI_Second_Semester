...
\begin{definition}
    The \eax{rank of a quadratic form} is the rank of the associated matrix. It is well-defined since any two congruent matrices have the same rank.
\end{definition}

\begin{definition}
    The \eax{index of a quadratic form} $q$ is the number of positive entries in the diagonal of the diagonal form of $q$.
\end{definition}

\begin{definition}
    The \eax{signature of a quadratic form} is the difference between the number of positive entries and the number of negative entries in the diagonal of the diagonal form of $q$.
\end{definition}
