...
\end{proof}
\begin{example}
    We question whether $\int_{a}^{\infty} \frac{dx}{e^{x}+1}$. Note that $\frac{1}{e^{x}+1} \leq e^{-x}$ for all $x \in [a,\infty)$. Evaluting the integral of the right hand side function,
    \begin{align}
