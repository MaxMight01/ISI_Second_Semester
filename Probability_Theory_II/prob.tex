...
\begin{align}
    ...
    &= P(\tilde{S_{1}}=1,\tilde{S_{2}}>0,\ldots,\tilde{S}_{n-m+1}>0) \notag\\
...
\begin{align}
    u_{2k} &= P(S_{2k}=0) = \frac{\binom{2k}{k}}{2^{2k}} = \frac{(2k)!}{(k!)^{2}2^{2k}} \notag \\
...
\begin{equation}
    P\left(\frac{\tilde{M}_{n}}{n}\right) = P\left(\frac{n-\tilde{M}_{n}}{n} \leq t\right) \to \frac{2}{\pi} \arcsin{\sqrt{t}}.
\end{equation}
...
\end{remark}
\begin{proof}
    Start with $X_{1},X_{2},\ldots$ which are independent and identically disitributed Bernoulli random variables, $\text{Ber}(x)$. Let $S_{n} = X_{1} + X_{2} + \ldots + X_{n}$. From the weak law of large numbers, we know that $\frac{S_{n}}{n}$ is approximately $x$. We can expect that $f(x)$ will also be approximately $f\left(\frac{S_{n}}{n}\right)$. We now have
    \begin{align}
        f_{n}(x) &= Ef\left(\frac{S_{n}}{n}\right) = \sum_{j=0}^{n} f\left(\frac{j}{n}\right)P(S_{n}=j) \notag \\
    ...
    \begin{align}
        \abs{f_{n}(x)-f(x)} &= \abs{\sum_{j=0}^{n} \left( f\left(\frac{j}{n}\right) - f(x) \right)} P(S_{n}=j) \notag \\
        &= \abs{\sum_{j \in A_{\delta}} \left( f\left(\frac{j}{n}\right) - f(x) \right) + \sum_{j \notin A_{\delta}} \left( f\left(\frac{j}{n}\right) - f(x) \right)} P(S_{n}=j) \notag \\
        &\leq \sum_{j \in A_{\delta}} \abs{ f\left(\frac{j}{n}\right) - f(x) } P(S_{n}=j) + \sum_{j \notin A_{\delta}} \abs{ f\left(\frac{j}{n}\right) - f(x) } P(S_{n}=j).
    \end{align}
    ...
    \begin{align}
        \sum_{j \in A_{\delta}} \abs{f\left(\frac{j}{n}\right)-f(x)} P(S_{n}=j) \leq \sum_{j \in A_{\delta}} \varepsilon P(S_{n} = j) \leq \varepsilon
    \end{align}
    and
    \begin{align}
        \sum_{j \notin A_{\delta}} \leq 2M P\left(\abs{\frac{S_{n}}{n}-x} > \delta\right) \leq 2M \frac{\text{Var}(S_{n})}{n^{2}\delta^{2}} = \frac{2Mnx(1-x)}{n^{2}\delta^{2}}.
    \end{align}
...
\begin{example}
    ...
    \begin{align}
        ...
        &= n\sum_{2^{k}>a_{n}} P(X=2^{k}) \leq \frac{2n}{a_{n}}.
    \end{align}
