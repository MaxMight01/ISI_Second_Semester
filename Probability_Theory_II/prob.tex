...
\begin{align}
    ...
    &\sim \frac{(2k)^{2k+\frac{1}{2}} e^{-2k} \sqrt{2\pi}}{(\sqrt{2pi} k^{k+\frac{1}{2}} e^{-k})^{2}2^{2k}} = \frac{1}{\sqrt{\pi k}}.
\end{align}
For $0 < a < b < 1$, we have
\begin{align}
...
We are now interested in $\tilde{M}_{n}$, the last time wen maximum up to time $n$ is attained. We can just look at the walk backwards again; in this case, we get
\begin{equation}
